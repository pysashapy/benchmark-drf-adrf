...
SECRET_KEY = 'django-insecure-%@zt12v%=@61qupftb=&h-8f0y6s%=%2c%z#m+8qmay-e(tx-1'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Django benchmark sync/async API',
    'VERSION': '1.0.0',
